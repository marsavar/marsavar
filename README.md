...
I'm a software engineer based in London, currently working at [Evervault](https://evervault.com).

Previously, I worked at [Snyk](https://snyk.io) and at [the Guardian](https://www.theguardian.com/) in the Investigations & Reporting team, a small group of developers using technology to uncover stories and building tools to make collaboration between reporters and whistleblowers more secure. I was a core member of the engineering team that implemented [CoverDrop](https://www.coverdrop.org/), a secure and anonymous messaging platform embedded in the news app.
